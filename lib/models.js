...
models.Application = {
  tableName: 'applications',
    ...
    //   }
    // }
    deployedVersions: Joi.object().pattern(/[a-z]+/, Joi.object().pattern(/[a-z0-9$-]+/, Joi.number())),
  },
  indexes: [
    {
      name: 'orgIdIndex',
...
models.Version = {
  ...
  schema: {
    ...
    // // the name of the environment where this version is currently deployed
    // environment: Joi.string(),
    //
    // // soft launch indicates that only a specific percentage of users
    // // will get this version.
    // softLaunch: Joi.boolean(),
    // softLaunchPercentage: Joi.boolean(),
