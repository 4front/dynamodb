...
module.exports = function(DynamoDb) {
  ...
  DynamoDb.prototype.updateDomain = function(domainData, callback) {
    ...
    this.models.Domain.update(_.pick(domainData, 'domain', 'appId', 'certificate', 'zone'),
      this._orgIdCondition(domainData.orgId), function(err, item) {
